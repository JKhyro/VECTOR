...
- the main interaction child now defaults to a bounded upstream Codex-style conversation-summary, selected-turn detail, approval/artifact continuity, thread-read, and turn-lifecycle preview, so useful Codex app interaction behavior is starting to land inside VECTOR without claiming a full upstream-base merge
