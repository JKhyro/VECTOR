...
- That contract exposes the left-menu, main-interaction, session-runtime, and tool-execution child programs as stable descriptors and routes workspace regions to those descriptors without requiring managed shell ownership.
